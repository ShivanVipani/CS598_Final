...
from dev_ids import valid_sv as dev_ids
...
def main():
    ...
    eval_models = set(dev_ids)#set(pool_ids[splitnum])
    ...
    if existsTimelinesFile('MEDIUM_timelines.pkl.gz'):

        sys.stderr.write("INFO: loading model predictions.\n")
        ss_ids,ns_ids,dev_predictions,ground_truth = loadAllTimelines('MEDIUM_timelines.pkl.gz')
        ...
        saveAllTimelines('MEDIUM_timelines.pkl.gz',
                         ss_ids,ns_ids,dev_predictions,ground_truth)
